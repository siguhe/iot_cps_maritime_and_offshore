...
To make a foundation to understed the methods found when using the research approach defined in \cref{sec:research_approach}, this chapter will describe some important terms, concepts and theory.
